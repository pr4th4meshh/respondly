        ...
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl dark:text-blue-300">
                Welcome to Respondly
              </h1>

              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                All your feedbacks management at one place with much more
                features.
              </p>
              ...
              >
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    id="Name"
                    name="name"
                    className="mt-1 py-2 px-2 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                  />
                </div>
